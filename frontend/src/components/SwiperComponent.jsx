...
const SwiperComponent = () => {
    const imgs = ["https://ifh.cc/g/PwPmH3.jpg", // 이미지 1
    ...
    return (<Swiper
            ...
            pagination={{
                clickable: true,
                dynamicBullets: true,
                renderBullet: (index, className) => (`<span class="${className}" style="background-color: black;"></span>`),
            }}
            loop={true}
            spaceBetween={50}
        ...
        >
            {imgs.map((image, index) => (<SwiperSlide key={index}>
