...
const Agreedetailbox = ({ isExpanded, type }) => {
    const getContent = (type) => {
        switch (type) {
            case 1:
                return <p>** 해당 서식은 공정거래위원회에서 제공하는 전자상거래 표준 약관으로 쇼핑몰 운영형태에 따른 수정이 필요할 수 있습니다. 쇼핑몰에 적용하시기 전 쇼핑몰 운영 사항 등을 확인하시고 관련 법령 등을 감안하여 적절한 내용을 반영하여 이용하시기 바랍니다. **
            ...
            case 2:
                return <p> ** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한 내용을 반영하여 사용하시기 바랍니다. **
                    ...
                    ※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.</p>;
            case 3:
                return <p>할인쿠폰 및 혜택, 이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 유익한 쇼핑정보를 SMS나 이메일로 받아보실 수 있습니다. 단, 주문/거래 정보 및 주요 정책과 관련된 내용은 수신동의 여부와 관계없이 발송됩니다.
    ...
    return (
        <div className={`Agreedetailbox ${isExpanded ? "expanded" : ""}`}>
            {isExpanded && getContent(type)}
        </div>
    );
};

export default Agreedetailbox;
